...
.right{
 ...
 <ul>
  ...
  Administration Login</font> </h2></h1>
  <br>
  
  <form action="login administration_c.php" method="post"><font size=4>
  Username:
   <input type="text" placeholder=" Enter Username"  name="user" required >
  <br><br>
  Employee ID:
   <input type="text" placeholder="  Enter Employee ID"  name="emplo" required >
  <br><br> 
  Password:
