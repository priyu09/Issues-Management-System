...
<font size=6>
<div>
<h1><h2 style="background-color:#008CBA;color:white" size="9">Administrative Member Detail</font> </h2></h1>
<form ><font size=4 >
<br>
<?php
...
if ($result->num_rows ===1) {
  ...
  while(  $row = $result->fetch_assoc() ){
    ...
    echo "Employee ID:" . $row['Emp_id'] ."<br><br>Name: " . $row['Name']."<br><br>Related Field: " . $row['Related_field']. "<br><br>Email ID:" . $row['Email_id'] . "<br><br>Contact number:". $row['Contact_no']."<br>"  ;          
    }
} else {
    echo "0 results";
}
